...
$delete_id= $_GET['id'];
$sql = "SELECT * FROM `postjob` WHERE `postjob`.`id` = '$delete_id'";
...
<section class="body1">
<div class="container">
  <form action="updatejobpostverify.php" method="post">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" name="universityname" value="<?php echo $row['universityname']?>">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="name" name="designation" value="<?php echo $row['designation']?>">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
      <input type="name" name="subject" value="<?php echo $row['subject']?>">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
      <input type="number" name="exp" value="<?php echo $row['exp']?>" >
      </div>
    </div>
    ...
    <div class="row">
      <center><button type="submit" name="submit" value="submit">update</button></center>
    </div>
  </form>
</div>
</section>
