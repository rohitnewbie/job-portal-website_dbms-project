...
input[type=text],input[type=password], select,input[list=Profiles] {
  width: 100%;
  padding: 12px;
...
<div class="container">
  <form action="register.php" method="post">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input list="Profiles" name="profile" id="profiles" placeholder="profile">
    ...
    <div class="row">
      <center><button type="submit" name="submit" value="submit">SIGNUP</button></center>
    </div>
  </form>
</div>
</section>
